...
namespace bunqAggregation.Intergration.IFTTT
{
    ...
    public class ActionsController : Controller
    {
        ...
        public IActionResult ActionPaymentRequest([FromBody] JObject content)
        {
            ...
            {
                var requestResponse = PaymentRequest.Execute(UserId, details);
                response.Add("metadata", new JObject {
        ...
        public IActionResult ActionPaymentAmount([FromBody] JObject content)
        {
            ...
            if (recipient == null)
            {
                ...
                JObject userObject = JObject.Parse((http.GetStringAsync(Config.Authority + "/connect/userinfo")).Result);
                recipient = userObject["name"];
            }
            ...
            {
                var paymentResponse = Payment.Execute(UserId, (JObject)details);
